    ...
    render() {
        return (
            <div className="w-75 d-flex flex-row flex-wrap align-content-start">
                ...
                <MovieElement movie={this.props.movies[4]} updateSelectedMovie={this.props.updateSelectedMovie} />
                <MovieElement movie={this.props.movies[5]} updateSelectedMovie={this.props.updateSelectedMovie} />
            </div>
        );
    }
}